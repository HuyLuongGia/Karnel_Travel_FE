...
const HotelSouth = () => {
    ...
    console.log(hotelId);
    const [hotelDetailSouth, setHotelDetailSouth] = useState(INIT_HOTEL_SOUTH);
    console.log(hotelDetailSouth);

    const getHotelSouthDetail = useCallback(() => {
        hotelKarnel
            .getHotelSouthDetail(hotelId)
            .then((res) => {
                // console.log(res);
                setHotelDetailSouth(res.data);
            })
            .catch((err) => {
                console.log(err);
            });
    ...
    return (
        <div className="HSDetail__container">
            <div className="HSDetail__banner">
                <div className="hSDetail__banner__item">
                    <div className="hSDetail__title">Stay</div>
                ...
                <div className="px-[10px] flex gap-3 pb-[10px]">
                    ...
                    >
                        <img
                            ...
                            src={hotelDetailSouth.hsouthImg}
                            alt="img
                        "
                        />
                    </div>
                    <div className="grow-[2] basis-0 ml-7">
                        <div className="flex justify-between items-center">
                            <div className="my-3 font-semibold text-white text-[20px] max-w-[200px] md:my-5 sm:max-w-[unset] sm:text-[25px] pr-[40px] md:pr-0 leading-[150%]">
                                {hotelDetailSouth.hsouthTitle.toUpperCase()}
                            </div>
                        </div>
                        <div className="flex gap-5 flex-col text-[#f58020] text-[16px] sm:text-[20px] sm:gap-10">
                            <div className="flex gap-5 items-center">
                                ...
                                <p className="text-white">
                                    {hotelDetailSouth.hsouthAddress}
                                </p>
                            </div>
                            <div className="flex gap-5 items-center">
                                <div className="w-[25px] h-[25px] text-center leading-[25px]">
                ...
                <div className="px-[10px] leading-[24px] mt-20">
                    ...
                    <div className="my-10">
                        <iframe
                            ...
                            src={hotelDetailSouth.hsouthVideo}
